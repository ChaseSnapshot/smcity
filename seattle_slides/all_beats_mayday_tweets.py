...
for iter in range(1): #len(police_beats_geojson)):
    print "Handling beat " + str(iter+1) + "/" + str(len(police_beats_geojson))
    ...
    print "Done handling beat " + str(iter+1) + "/" + str(len(police_beats_geojson))

print "Writing out GeoJSON display..."
outfile = open('all_beats_mayday_tweets_and_stuff.geojson', 'w')
